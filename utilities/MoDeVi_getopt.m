function value = MoDeVi_getopt(structure, option, defaultVal)
% MODEVI_GETOPT gets the value of a specified option from a cfg structure.
%
% Use as
%   value = MoDeVi_getopt(structure, option, defaultVal)
